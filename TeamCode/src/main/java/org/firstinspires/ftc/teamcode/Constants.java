...
public class Constants {
    ...
    public static class BlockerConstants {
        ...
        public static double BLOCK_POSITION = 0.14; // Position for the whacker to whack the artifact
    ...
    public static class Poses {
        ...
        public Poses(Alliance alliance) {
            ...
            this.score = mirrorPoses ? buildPose(47.8,  111, 137, true) : buildPose(42,  105, 136, false); //red first : blue second
            ...
            this.PPGArtifactsEnd = buildPose(50, 51, 194, mirrorPoses);
            this.PGPArtifactsEnd = buildPose(30, 71, 170, mirrorPoses);
